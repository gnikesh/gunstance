...
while getopts s:h:t:e:i:d:b:r: flag
do
    case "${flag}" in
        s) SOFT_AUG=${OPTARG};;
        h) HARD_AUG=${OPTARG};;
...
echo "==================================================="
echo "$TASK    $EVAL_TASK        $SOFT_AUG    $HARD_AUG        $DATE    $INDEX"
echo "==================================================="
...
python textTrainHF.py \
    ...
    --out "${RESULTS_DIR}/${TASK}_${EVAL_TASK}_${SOFT_AUG}_${HARD_AUG}_lu1_mu7_ema0_${DATE}_${INDEX}"

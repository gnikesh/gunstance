...
def calculate_calibration_error(elems, n_classes, temperature=None, average='macro'):
    ...
    pr, rc, f1, sp = precision_recall_fscore_support(labels, preds, average=average)
